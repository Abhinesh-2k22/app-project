...
<section class="bg-white">
    <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="agree" class="ml-3 text-sm font-medium text-gray-500">
                                I agree to Unihub’s <a href="#" title="" class="text-blue-600 hover:text-blue-700 hover:underline">Terms of Service</a> and <a href="#" title="" class="text-blue-600 hover:text-blue-700 hover:underline">Privacy Policy</a>
                            </label>
                        </div>

                        <div>
                            <button  class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">
                                Login
                            </button>
                        </div>
                    </div>
        ...
        <div class="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-gray-50 sm:px-6 lg:px-8">
            <div>
                <img class="w-full mx-auto" src="/pngegg.png" alt="" />

                <div class="w-full max-w-md mx-auto xl:max-w-xl">
                    <h3 class="text-2xl font-bold text-center text-black">Know Your Locality</h3>
                    <p class="leading-relaxed text-center text-gray-500 mt-2.5">From renting to groceries, we've got you covered from A to Z!</p>
